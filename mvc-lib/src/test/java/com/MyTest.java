...
public class MyTest {
    ...
    @Test
    public void ss() {
        System.out.println("\"abcdefg\".substring(3) = " + "abcdefg".substring(3));
        PathMatcher pathMatcher = PathMatcher.DEFAULT_PATH_MATCHER;
        //System.out.println("pathMatcher.isMatch(\"*\", \"ab\") = " + pathMatcher.isMatch("**", "ab"));
        System.out.println("pathMatcher.isMatch(\"*\", \"ab\") = " + pathMatcher.isMatch("/a/**/**/**/def", "/a/b/c/def"));
    }
