...
public class MethodInvoker {
    ...
    private HandlerMethodArgumentResolverComposite resolvers = HandlerMethodArgumentResolverComposite.defaultInstance();
    ...
    public Object invoke(Object instance, Method method, HttpServletRequest request) throws Exception {
        ...
        return doInvoke(instance, method, request, prefixStack);
    }
